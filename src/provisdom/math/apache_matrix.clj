...
(declare apache-matrix? apache-square-matrix? apache-matrix eigen-decomposition
         ...
         get-entry assoc-entry! symmetric-apache-matrix-by-averaging!
         assoc-diagonal!)
...
(defn rnd-correlation-apache-matrix-finite!
  "Returns a finite correlation Apache Commons matrix from a covariance matrix
  ...
  Alternative #2: Use [[correlation-apache-matrix-finite-by-squaring]] with a
