...
(deftest single-non-?-test
  (is (single-non-? 0))
  (is (single-non-? 1))
  (is-not (single-non-? -1))
  (is (single-non-? 3.3E30))
  (is-not (single-non-? -3.3E30))
  (is-not (single-non-? 3.3E300))
  (is-not (single-non-? -3.3E300))
  (is (single-non-? inf+))
  (is-not (single-non-? inf-))
  (is-not (single-non-? nan))
  (is-not (single-non-? "A")))
