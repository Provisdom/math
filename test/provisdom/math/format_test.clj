...
(deftest format-as-exponential-test
  ...
  (is= "3.23E+20" (format/format-as-exponential 3.232348938493849E20 {::format/digits 3}))
  (is= "3.232348938493849E+20" (format/format-as-exponential 3.232348938493849E20))
...
(deftest format-number-test
  ...
  (is= "23423.42" (format/format-number 23423.4234 9 {::format/max-decimal-places 2}))
  (is= "23423.4" (format/format-number 23423.4234 8 {::format/max-decimal-places 1}))
  (is= "23423" (format/format-number 23423.4234 5 {::format/max-decimal-places 0}))
  (is= "23423" (format/format-number 23423.4234 4 {::format/max-decimal-places 0}))
  (is= "2E+5" (format/format-number 234233.4234 4 {::format/max-decimal-places 0}))
  (is= "2.34231E+11" (format/format-number 2.342311111114234E11 11 {::format/max-decimal-places 1}))
  (is= "2.3423E+11" (format/format-number 2.342311111114234E11 11 {::format/max-digits 5}))
  (is= "0E+0" (format/format-number 2.34231E-7 11 {::format/max-decimal-places 3}))
  ...
  (is= "-23423.42" (format/format-number -23423.4234 10 {::format/max-decimal-places 2}))
  (is= "-23423.4" (format/format-number -23423.4234 9 {::format/max-decimal-places 1}))
  (is= "-23423" (format/format-number -23423.4234 6 {::format/max-decimal-places 0}))
  (is= "-23423" (format/format-number -23423.4234 5 {::format/max-decimal-places 0}))
  (is= "-2E+5" (format/format-number -234233.4234 5 {::format/max-decimal-places 0}))
  (is= "-2.34231E+11" (format/format-number -2.342311111114234E11 12 {::format/max-decimal-places 1}))
...
(deftest unparse-shorthand-test
  ...
  (is= "323.23432412M" (format/unparse-shorthand 3.23234324123124E8 13 {::format/max-decimal-places 2}))
  (is= "320M" (format/unparse-shorthand 3.23234324123124E8 13 {::format/max-digits 2}))
