...
(deftest chebyshev-polynomial-fn-test
  ...
  (is= 1.0 ((series/chebyshev-polynomial-fn 0 {::series/second-kind? true}) 1.0))
  (is= 2.0 ((series/chebyshev-polynomial-fn 1 {::series/second-kind? true}) 1.0))
  (is= 3.0 ((series/chebyshev-polynomial-fn 2 {::series/second-kind? true}) 1.0))
  (is= 4.0 ((series/chebyshev-polynomial-fn 3 {::series/second-kind? true}) 1.0))
  (is= 5.0 ((series/chebyshev-polynomial-fn 4 {::series/second-kind? true}) 1.0))
  (is= 6.0 ((series/chebyshev-polynomial-fn 5 {::series/second-kind? true}) 1.0))
  (is= 7.0 ((series/chebyshev-polynomial-fn 6 {::series/second-kind? true}) 1.0))
  (is= 8.0 ((series/chebyshev-polynomial-fn 7 {::series/second-kind? true}) 1.0))
  (is= 9.0 ((series/chebyshev-polynomial-fn 8 {::series/second-kind? true}) 1.0))
  (is= 10.0 ((series/chebyshev-polynomial-fn 9 {::series/second-kind? true}) 1.0))
  (is= 11.0 ((series/chebyshev-polynomial-fn 10 {::series/second-kind? true}) 1.0))
  (is= 12.0 ((series/chebyshev-polynomial-fn 11 {::series/second-kind? true}) 1.0))
  (is= 13.0 ((series/chebyshev-polynomial-fn 12 {::series/second-kind? true}) 1.0))
  (is= 14.0 ((series/chebyshev-polynomial-fn 13 {::series/second-kind? true}) 1.0))
  (is= 4.0 ((series/chebyshev-polynomial-fn 1 {::series/second-kind? true}) 2.0))
  (is= 35.0 ((series/chebyshev-polynomial-fn 2 {::series/second-kind? true}) 3.0))
  (is= 496.0 ((series/chebyshev-polynomial-fn 3 {::series/second-kind? true}) 4.0))
  (is= 9701.0 ((series/chebyshev-polynomial-fn 4 {::series/second-kind? true}) 5.0))
  (is= 241956.0 ((series/chebyshev-polynomial-fn 5 {::series/second-kind? true}) 6.0))
  (is= 7338631.0 ((series/chebyshev-polynomial-fn 6 {::series/second-kind? true}) 7.0))
  (is= 2.62184896E8 ((series/chebyshev-polynomial-fn 7 {::series/second-kind? true}) 8.0))
  (is= 1.0783446409E10 ((series/chebyshev-polynomial-fn 8 {::series/second-kind? true}) 9.0))
  (is= 5.018270401E11 ((series/chebyshev-polynomial-fn 9 {::series/second-kind? true}) 10.0))
  (is= 2.6069206375211E13 ((series/chebyshev-polynomial-fn 10 {::series/second-kind? true}) 11.0))
  (is= 1.4954277353148E15 ((series/chebyshev-polynomial-fn 11 {::series/second-kind? true}) 12.0))
  (is= 9.3885489910449904E16 ((series/chebyshev-polynomial-fn 12 {::series/second-kind? true}) 13.0))
  (is= 41.76799999999999 ((series/chebyshev-polynomial-fn 3) 2.3))
  (is= -0.7307444539392003 ((series/chebyshev-polynomial-fn 13) 0.3))
  (is= 88.13599999999997 ((series/chebyshev-polynomial-fn 3 {::series/second-kind? true}) 2.3))
  (is= -0.9454282973183997 ((series/chebyshev-polynomial-fn 13 {::series/second-kind? true}) 0.3)))
...
(deftest chebyshev-derivative-fn-test
  ...
  (is= 2.0 ((series/chebyshev-derivative-fn 1 1 {::series/second-kind? true}) 1.0))
  (is= 2.220446049250313E-9 ((series/chebyshev-derivative-fn 1 2 {::series/second-kind? true}) 1.0))
  (is= 8.0 ((series/chebyshev-derivative-fn 2 1 {::series/second-kind? true}) 1.0))
  (is= 8.00000000911183 ((series/chebyshev-derivative-fn 2 2 {::series/second-kind? true}) 1.0))
  (is= 20.0 ((series/chebyshev-derivative-fn 3 1 {::series/second-kind? true}) 1.0))
  (is= 48.00000002358473 ((series/chebyshev-derivative-fn 3 2 {::series/second-kind? true}) 1.0))
  (is= 47.99999995697135 ((series/chebyshev-derivative-fn 3 3 {::series/second-kind? true}) 1.0)))
...
(defspec-test test-chebyshev-polynomial-factors-to-regular-polynomial-factors
              `series/chebyshev-polynomial-factors-to-regular-polynomial-factors)

;;;SERIES
(deftest polynomial-fn-test
  (is= [1.0 4.0 16.0 64.0] ((series/polynomial-fn 3) 4.0))
  (is= [4.0 16.0 64.0] ((series/polynomial-fn 3 {::series/start-degree 1}) 4.0))
  (is= [1.0 4.0 31.0 244.0] ((series/polynomial-fn 3 {::series/chebyshev-kind 1}) 4.0))
  (is= [1.0 8.0 63.0 496.0] ((series/polynomial-fn 3 {::series/chebyshev-kind 2}) 4.0)))

(deftest polynomial-fns-test
  (is= [1.0 4.0 16.0 64.0] (map #(% 4.0) (series/polynomial-fns 3)))
  (is= [4.0 16.0 64.0] (map #(% 4.0) (series/polynomial-fns 3 {::series/start-degree 1})))
  (is= [1.0 4.0 31.0 244.0] (map #(% 4.0) (series/polynomial-fns 3 {::series/chebyshev-kind 1})))
  (is= [1.0 8.0 63.0 496.0] (map #(% 4.0) (series/polynomial-fns 3 {::series/chebyshev-kind 2}))))
...
(deftest power-series-integral-fn-test
  (is= [22.0 24.0 34.666666666666664] ((series/power-series-integral-fn [11 12 13]) 2.0)))
...
(defspec-test test-power-series-derivative-fn `series/power-series-derivative-fn)
(defspec-test test-power-series-integral-fn `series/power-series-integral-fn)
(defspec-test test-continued-fraction `series/continued-fraction)
(defspec-test test-generalized-continued-fraction `series/generalized-continued-fraction)
